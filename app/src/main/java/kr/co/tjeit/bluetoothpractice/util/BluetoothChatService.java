package kr.co.tjeit.bluetoothpractice.util;
...
public class BluetoothChatService {
    ...
    //    접속을 수락하는데 사용되는 쓰레드.
//    접속을 수락 => 누군가가 원격에서 나에게 채팅을 요청하면 받아들이는 기능.
...
//        아직 통신을 시작하지 않았으니, 상태값을 아무것도 안하고 있는 것으로 기록.
...
//        필요한 핸들러를 주입
    ...
    //    현재 연결상태 값을 세팅.
//    synchronized => 여러개의 쓰레드가 동시에 접근하는 것을 막기 위한 안전장치.
//    여러개의 쓰레드가 동시에 접근해서 값이 꼬이는 것을 막는다.
    private synchronized void setState(int state) {
        mState = state;

//        채팅을 하는 화면에 현재 상태를 전달해준다.
//        TODO - => 채팅 액티비티가 화면을 수정할 수 있도록 메세지 전달.
//        mHandler.obtainMessage(Blu)
...
//    통신 중간에 연결이 끊겼을 때
    ...
    private class AcceptThread extends Thread {
        ...
        BluetoothServerSocket mServierSocket = null;
